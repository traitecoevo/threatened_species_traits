...
#austraits <- readRDS("ignore/austraits/austraits_20250616.rds") # not required if you read in complete RDS file
...
all_traits <-readRDS("~/github/threatened_species_traits/ignore/austraits/all_traits.20250616.rds") # static file with all data 2025-06-16
```
...
threat_independent_risk <- threat_independent_risk_tmp %>%
  ...
  mutate(
    ...
    # sum trait risk effect scores
      total_trait_effect_score = rowSums(across(c(seed_dry_mass_scaled_risk, seedbank_location_risk, vegetative_reproduction_ability_risk, dispersers_risk, lifespan_scaled_risk, vegetative_reproduction_ability_risk, reproductive_maturity_scaled_risk)), na.rm = TRUE)
  ) %>%
