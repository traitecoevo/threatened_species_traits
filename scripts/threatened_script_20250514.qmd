...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
  ...
  phytophthora_assigned_risk %>%
    ...
    arrange(-taxonomic_risk_effect_score, family) %>% 
  ...
  phytophthora_assigned_risk %>%
    ...
    arrange(-taxonomic_risk_effect_score, genus) %>% 
...
pigs_taxonomic_effects %>%
  arrange(-effect_scores, taxon_rank, taxon) %>% 
