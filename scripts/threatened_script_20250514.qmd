...
#austraits <- readRDS("ignore/austraits/austraits-7.0.0.rds") # not required if you read in complete RDS file
...
```{r, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
numeric_traits <- c("seed_dry_mass", "leaf_mass_per_area", "plant_height", "leaf_length", "leaf_mass_per_area", "leaf_N_per_dry_mass", "leaf_P_per_dry_mass", "reproductive_maturity", "seedbank_longevity", "leaf_water_content_per_area", "leaf_tannin_per_dry_mass", "leaf_phenol_per_dry_mass", "leaf_lignin_per_dry_mass", "digestible_mass_per_dry_mass", "leaf_crude_protein_per_dry_mass", "leaf_work_to_shear_adjusted", "fruit_length", "metabolisable_energy", "bark_thickness", "lifespan")
...
```{r, results='hide', message=FALSE, warning=FALSE}
lifespan_data <- all_traits %>% extract_trait("lifespan", partial_matches_allowed = F)
...
# Threat-based susceptibility scoring
...
# Threat-independent scoring component

## Ability of population to compensate
...
threat_independent_effects <- tribble(
  ...
  "plant_height_scaled",            0.5,          "short plants = less height growth required before reproducing",
...
threat_independent_risk <- threat_independent_risk_tmp %>%
  ...
  mutate(
    ...
    # woody taxa have highest impact
